...
(function (global) {
  ...
  const TABLE = {
    en: {
      ...
      btnLevels: 'Levels',
      levelsHelp: 'Show the image as tonal zones: five even windows of its luminance range, with the selected window highlighted, so the dark, mid and light masses are easy to find. Display only \u2014 colour picking still reads the real image.',
      levelsBand: 'Levels window',
      levelZone1: 'Shadows',
      levelZone2: 'Dark mids',
      levelZone3: 'Mids',
      levelZone4: 'Light mids',
      levelZone5: 'Highlights',
      ...
      traceGridPx: '{n} px',
      traceGrey: 'Greyscale',
      traceGreyHelp: 'Show the traced photo in greyscale so tonal values are easier to read (display only \u2014 the colour view and line drawing are unaffected).',
      ...
      traceExitTitle: 'Leave projection?',
      traceExitMsg: 'Exiting stops the camera and returns to the image editor.',
      traceExitConfirm: 'Exit',
      ...
      arAdjust: 'Adjust pins',
      arAdjustStop: 'Stop adjusting',
      arFine: 'Fine',
      arFineHelp: 'Scale pointer movement down for sub-pixel pin placement (drag farther to move a pin a little).',
      arAdjustLoupeSrc: 'Image',
      arAdjustLoupeTgt: 'Surface',
      ...
      stepTraceTitle: 'Tracing',
      stepTraceBody: 'Tracing projects the loaded image over a live camera feed so you can copy it onto paper or a surface. Turn the image into a line drawing, overlay an image-locked proportion grid, and adjust opacity to see your work. On a small screen the controls collapse to a dock at the bottom while you pin.',
